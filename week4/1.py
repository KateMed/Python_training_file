...
#в итоге имеем программу, которая, если что создат файл сама, если его не существует по выбранному направлению

# работать не будет только в том случае, если файл все-таки будет искаться по какому-то другому пути
